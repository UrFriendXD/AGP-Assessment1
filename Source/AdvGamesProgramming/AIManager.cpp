...
void AAIManager::BeginPlay()
{
    ...
    // GetWorldTimerManager().SetTimer(CoverSpawnTimer, this, &AAIManager::PopulateNodes, 10.0f, false, 10.0f);
    // GetWorldTimerManager().SetTimer(NodesSpawnTimer, this, &AAIManager::PopulateCovers, 10.0f, false, 10.0f);
    //PopulateNodes();
    //CreateAgents();
}
...
void AAIManager::Tick(float DeltaTime)
{
    ...
    // {
    //     if (ProceduralGeneration->bIsOutOfBounds && !bHasSpawned)
    //     {
    //         PopulateNodes();
    //         PopulateCovers();
    //         bHasSpawned = true;
...
//         AEnemyCharacter* Agent = GetWorld()->SpawnActor<AEnemyCharacter>(
//             AgentToSpawn, AllNodes[RandIndex]->GetActorLocation(), FRotator(0.f, 0.f, 0.f));
//         Agent->Manager = this;
...
//             AllNodes.Add(GetWorld()->SpawnActor<ANavigationNode>(Vertices[Row * Width + Col], FRotator::ZeroRotator,
