...
void AMultiplayerGameMode::InitGame(const FString& MapName, const FString& Options, FString& ErrorMessages)
{
	...
	// ProceduralGeneration = GetWorld()->SpawnActor<AProceduralGeneration>();
	// ProceduralSpawner = GetWorld()->SpawnActor<AProceduralSpawner>();
	// ProceduralGeneration->ProceduralSpawner = ProceduralSpawner;
}
